...
3. Untuk **Unit Test** gunakan command ```vendor/bin/phpunit``` pada terminal. Untuk Test Case update dan delete book anda harus menggunakan book ID yang sebenarnya agar test mendapatkan result pass.
